...
public final class AuthServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<auth.Auth.TokenRequest,
      auth.Auth.TokenResponse> getVerifyTokenMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "VerifyToken",
      requestType = auth.Auth.TokenRequest.class,
      responseType = auth.Auth.TokenResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<auth.Auth.TokenRequest,
      auth.Auth.TokenResponse> getVerifyTokenMethod() {
    io.grpc.MethodDescriptor<auth.Auth.TokenRequest, auth.Auth.TokenResponse> getVerifyTokenMethod;
      ...
      synchronized (AuthServiceGrpc.class) {
        if ((getVerifyTokenMethod = AuthServiceGrpc.getVerifyTokenMethod) == null) {
          AuthServiceGrpc.getVerifyTokenMethod = getVerifyTokenMethod =
              io.grpc.MethodDescriptor.<auth.Auth.TokenRequest, auth.Auth.TokenResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "VerifyToken"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  auth.Auth.TokenRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  auth.Auth.TokenResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void verifyToken(auth.Auth.TokenRequest request,
        io.grpc.stub.StreamObserver<auth.Auth.TokenResponse> responseObserver) {
  ...
  public static final class AuthServiceStub
    ...
    /**
     */
    public void verifyToken(auth.Auth.TokenRequest request,
        io.grpc.stub.StreamObserver<auth.Auth.TokenResponse> responseObserver) {
  ...
  public static final class AuthServiceBlockingStub
    ...
    /**
     */
    public auth.Auth.TokenResponse verifyToken(auth.Auth.TokenRequest request) {
  ...
  public static final class AuthServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<auth.Auth.TokenResponse> verifyToken(
        auth.Auth.TokenRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_VERIFY_TOKEN:
          serviceImpl.verifyToken((auth.Auth.TokenRequest) request,
              (io.grpc.stub.StreamObserver<auth.Auth.TokenResponse>) responseObserver);
          break;
        default:
